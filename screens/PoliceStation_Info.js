...
const PoliceStation_Info = ({ navigation, route }) => {
    ...
    const getAllPoliceStations = () => {
        ...
        var InsertApiURL = `http://${ip}/RescueAgencyApi/api/PoliceStation/GetPoliceStationInfo`;
        fetch(InsertApiURL, {
            method: 'GET',
        })
    ...
    const deleteRecord = (id) => {
        ...
        var InsertApiURL = `http://${ip}/RescueAgencyApi/api/PoliceStation/DeletePoliceStation?id=${id}`;//AddOrEditPoliceStation
        fetch(InsertApiURL,
            {
                method: 'GET',
            }
                ...
                isFetch == true ? (
                    ...
                    <View style={{ flex: 1, backgroundColor: 'green' }}>
                        ...
                        <TouchableOpacity onPress={() => {
                            navigation.navigate('EditPoliceStation_Info', {
                                Id: '',
                                Name: '',
                                Address: '',
                                lat: '',
                        ...
                        <FlatList showsVerticalScrollIndicator={false}
                            ...
                            refreshControl={
                                <RefreshControl
                                    onRefresh={() => getAllPoliceStations()}
                                    refreshing={loading}
                                    tintColor="red"
                                    colors={["red", "green"]}
                                />
...
export default PoliceStation_Info;
