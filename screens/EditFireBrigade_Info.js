...
const EditFireBrigade_Info = ({ navigation, route }) => {
    ...
    const saveData = () => {
        if (name.length == 0) {
            ...
            var InsertApiURL = `http://${ip}/RescueAgencyApi/api/FireBrigade/AddOrEditFireBrigade`;
            var headers = {
...
export default EditFireBrigade_Info;
