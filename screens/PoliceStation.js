...
const PoliceStation = ({ navigation, route }) => {
    const [data, setData] = useState([]);
    useEffect(() => {
        // var InsertApiURL = `http://${ip}/RescueAgencyApi/api/PoliceStation/GetNearestPoliceStationInfo?lat=${ route.params.currentLat}&${route.params.currentLng}`;
        var InsertApiURL = `http://${ip}/RescueAgencyApi/api/PoliceStation/GetNearestPoliceStationInfo?lat=${route.params.currentLat}&lng=${route.params.currentLng}`;
        fetch(InsertApiURL, {
            method: 'GET',
        })
