...
const Parking_Info = ({ navigation, route }) => {
    ...
    const deleteRecord = (id) => {
        ...
        var InsertApiURL = `http://${ip}/RescueAgencyApi/api/Parking/DeleteParking?id=${id}`; //AddOrEditParking
        fetch(InsertApiURL,
            {
                method: 'GET',
            }
                ...
                isFetch == true ? (
                    ...
                    <View style={{ flex: 1, backgroundColor: 'green' }}>
                        ...
                        <TouchableOpacity onPress={() => {
                            navigation.navigate('EditParking_Info', {
                                Id: '',
                                Name: '',
                                Address: '',
                                lat: '',
